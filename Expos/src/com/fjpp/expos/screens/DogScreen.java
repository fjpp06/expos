...
public class DogScreen {
	...
	public DogScreen(String userId, String userName) {
		this.userid = userId;
		...
		lblBreed.setFont(new Font(Font.SANS_SERIF, Font.PLAIN, 16));
		lblBreed.setForeground(Color.BLACK);
		lblBreed.setBounds(75, 200, 50, 50);
		frame.add(lblBreed);
		...
		register.setBounds(300, 350, 150, 50);
		register.setForeground(Color.BLACK);
		frame.add(register);
		
		new DogController(this);
	}
}
