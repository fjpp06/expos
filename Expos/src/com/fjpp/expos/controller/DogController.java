	...
	private void RegisterDog() {
		...
		try {
			...
			if (rowsAffected > 0) {
				...
				MainScreen mainscreen = new MainScreen(dogscreen.userid, dogscreen.username);
				mainscreen.frame.setVisible(true);
				mainscreen.welcome.setText("Dog registered successfully!");
				mainscreen.welcome.setFont(new Font(Font.SANS_SERIF, Font.BOLD, 24));
				mainscreen.welcome.setBounds(75, 25, 500, 100);
			} else {
